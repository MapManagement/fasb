...
pub const FACET_COMMANDS: &[&str] = &[
    ...
    IS_FACET_R,
    // Aliase
    ACTIVATE_FACETS_ALIAS,
    ACTIVATE_FACETS_LT_ALIAS,
    ACTIVATE_FACETS_LAZY_ALIAS,
    SHOW_FACETS_ALIAS,
    COMPUTE_FACETS_SU_ALIAS,
    COMPUTE_FACETS_ALIAS,
    FACET_COUNT_ALIAS,
    FACET_COUNTS_ALIAS,
    FACET_COUNTS_PROJECTING_ALIAS,
    WEIGHTED_FACET_COUNT_ALIAS,
    WEIGHTED_FACET_COUNTS_ALIAS,
    SHOW_ROUTE_ALIAS,
    CLEAR_ROUTE_ALIAS,
    DEL_LAST_ALIAS,
    SIGNIFICANCE_ALIAS,
    SIGNIFICANCE_PROJECTING_ALIAS,
    IS_FACET_ALIAS,
    IS_FACET_R_ALIAS,
];
...
pub const OTHER_COMMANDS: &[&str] = &[
    ...
    OPTIMIZATION,
    // Aliase
    ANSWER_SET_COUNT_ALIAS,
    ANSWER_SET_COUNTS_ALIAS,
    ENUMERATE_SOLUTIONS_ALIAS,
    ENUMERATE_PROJECTED_SOLUTIONS_ALIAS,
    CHANGE_MODE_ALIAS,
    PROPOSE_STEP_ALIAS,
    TAKE_STEP_ALIAS,
    CACHE_ALIAS,
