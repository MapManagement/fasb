...
mod tests {
    use super::*;
    use savan::lex::repr;
    use savan::nav::{Navigator, errors::*, facets::*};
    ...
    fn q8_max_fc() -> Result<()> {
        ...
        for _ in 0..24 {
                ...
                Mode::MaxWeightedFacetCounting(count).propose_facet(&mut nav, &mut active, &among)
            {
                ...
                assert!(
                    vec![
                        "q(4,1)", "q(3,5)", "q(8,5)", "q(4,7)", "q(5,3)", "q(7,8)", "q(1,3)",
                        "q(1,4)", "q(8,7)", "q(5,8)", "q(3,1)", "q(7,4)"
                    ]
                    .contains(&f.as_str())
                );
            } else {
        ...
        for _ in 0..30 {
                ...
                Mode::MaxWeightedFacetCounting(count).propose_facet(&mut nav, &mut active, &among)
            {
                ...
                assert!(
                    vec![
                        "q(4,7)", "q(1,2)", "q(6,5)", "q(8,4)", "q(3,5)", "q(4,5)", "q(8,7)",
                        "q(1,6)", "q(1,3)", "q(5,6)", "q(8,6)", "q(3,6)", "q(3,2)", "q(4,4)",
                        "q(7,5)"
                    ]
                    .contains(&f.as_str())
                );
    ...
    fn q8_min_fc() -> Result<()> {
        ...
        for _ in 0..70 {
                ...
                Mode::MinWeightedFacetCounting(count).propose_facet(&mut nav, &mut active, &among)
            {
                ...
                assert!(
                    vec![
                        "~q(3,1)", "~q(8,6)", "~q(4,8)", "~q(5,7)", "~q(3,2)", "~q(5,6)",
                        "~q(2,2)", "~q(2,4)", "~q(3,4)", "~q(4,3)", "~q(1,2)", "~q(7,1)",
                        "~q(5,8)", "~q(7,4)", "~q(4,1)", "~q(2,5)", "~q(4,6)", "~q(2,7)",
                        "~q(7,2)", "~q(6,1)", "~q(5,2)", "~q(6,4)", "~q(7,5)", "~q(3,8)",
                        "~q(1,8)", "~q(4,7)", "~q(6,5)", "~q(7,7)", "~q(3,3)", "~q(6,3)",
                        "~q(3,6)", "~q(1,3)", "~q(1,6)", "~q(7,6)", "~q(2,8)", "~q(1,5)",
                        "~q(8,5)", "~q(1,1)", "~q(8,2)", "~q(4,4)", "~q(6,7)", "~q(7,3)",
                        "~q(2,6)", "~q(4,5)", "~q(6,6)", "~q(5,4)", "~q(2,1)", "~q(8,7)",
                        "~q(2,3)", "~q(3,5)", "~q(1,7)", "~q(8,8)", "~q(8,4)", "~q(5,5)",
                        "~q(6,8)", "~q(8,1)", "~q(8,3)", "~q(4,2)", "~q(1,4)", "~q(5,1)",
                        "~q(3,7)", "~q(5,3)", "~q(6,2)", "~q(7,8)"
                    ]
                    .contains(&f.as_str())
                );
            } else {
        ...
        for _ in 0..22 {
                ...
                Mode::MinWeightedFacetCounting(count).propose_facet(&mut nav, &mut active, &among)
            {
                ...
                assert!(
                    vec![
                        "~q(8,7)", "~q(3,5)", "~q(4,1)", "~q(1,4)", "~q(1,3)", "~q(5,8)",
                        "~q(3,1)", "~q(8,5)", "~q(4,7)", "~q(7,4)", "~q(5,3)", "~q(7,8)",
                    ]
                    .contains(&f.as_str())
                );
            } else {
    ...
    fn q8_max_as() -> Result<()> {
        ...
        for _ in 0..16 {
            ...
            if let Some((f, c)) = Mode::MaxWeightedAnswerSetCounting(count).propose_facet(
                ...
                assert!(
                    vec![
                        "q(3,3)", "q(6,6)", "q(3,6)", "q(6,3)", "q(1,1)", "q(1,8)", "q(8,1)",
                        "q(8,8)"
                    ]
                    .contains(&f.as_str())
                );
        ...
        for _ in 0..24 {
            ...
            if let Some((f, c)) = Mode::MaxWeightedAnswerSetCounting(count).propose_facet(
                ...
                assert!(
                    vec![
                        "q(3,1)", "q(1,3)", "q(4,1)", "q(1,4)", "q(4,7)", "q(7,4)", "q(8,5)",
                        "q(5,8)", "q(3,5)", "q(5,3)", "q(7,8)", "q(8,7)"
                    ]
                    .contains(&f.as_str())
                );
            } else {
